...
if (isset($_SESSION['leerling_data']) || isset($_SESSION['coach_data'])|| isset($_SESSION['admin_data']) || isset($_SESSION['bedrijf_data']) ) {
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm">
                <a href="bedrijventoevoegen.php">
                    <img src="img/users.png" width="175px" height="175px"><br>
                    <button type="button" class="btn btn-color">Praktijkbegeleider Toevoegen</button>
                </a>
            </div>

            <div class="col-sm">
                <a href="bedrijvenoverzicht.php">
                    <img src="img/users.png" width="175px" height="175px"><br>
                    <button type="button" class="btn btn-color">Praktijkbegeleider Overzicht</button>
                </a>
                </a>
            </div>
        </div>
